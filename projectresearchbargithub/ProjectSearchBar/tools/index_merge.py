...
def merge_index(scan_path: Path, db_path: Path, reset: bool = False, limit_papers: int | None = None):
...
def main(argv=None) -> int:
    ...
    merge_index(args.scan, args.db, reset=args.reset, limit_papers=args.limit_papers)
    return 0
